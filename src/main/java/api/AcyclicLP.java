package api; /*************************************************************************
 *  Compilation:  javac api.AcyclicLP.java
 ...
 *
 *  % java api.AcyclicLP tinyEWDAG.txt 5
...
/**
 *  The <tt>api.AcyclicLP</tt> class represents a data type for solving the
...
public class AcyclicLP {
    ...
    /**
     * Unit tests the <tt>api.AcyclicLP</tt> data type.
     */
